        ...
        showProfile.map((showProfile: any) => {
            return (
                <div key={showProfile._id} className='ml-60 -mt-150 w-100 h-100 bg-white shadow-lg' >
                    ...
                    <button className='bg-black text-white p-2 h-15 w-30 rounded-4xl ml-15 mt-13 '>Accept</button>
                    <button className='bg-black text-white p-2 h-15 w-30 rounded-4xl ml-15 mt-13 '>Reject</button>
                </div >
            )
